...
def straight_line_test():
    ...
    buggy.Stop()
    sleep(500)
    buggy.Reverse(2, decrease_left=inc, decrease_right=0)
    sleep(200)
    buggy.Reverse(5, decrease_left=inc, decrease_right=0)
    sleep(200)
    buggy.Reverse(9, decrease_left=inc, decrease_right=0)
    sleep(1000)
    buggy.Reverse(5, decrease_left=inc, decrease_right=0)
    sleep(200)
    buggy.Reverse(2, decrease_left=inc, decrease_right=0)
