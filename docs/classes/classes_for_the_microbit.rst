...
| See: `<https://www.w3schools.com/python/python_classes.asp>`_
| See: `<https://pc-microbit-extension.readthedocs.io/en/latest/classes/classes_for_the_microbit.html>`_
...
| The _init_() function assigns values to object properties when the object is created.
