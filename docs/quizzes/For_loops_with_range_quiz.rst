...
.. multichoice::
    ...
    [x] 0 | Correct. The documentation specifies that the range() function returns a sequence of numbers starting from 0 by default.
    ...
    [ ] It starts at a completely random integer. | Incorrect. The function generates a strict deterministic sequence.
...
.. multichoice::
    ...
    [ ] It multiplies the previous value by 2. | Incorrect. It produces a linear arithmetic sequence, not a geometric progression.
...
.. multichoice::
    ...
    [ ] 0, 3, 6 | Incorrect. This multiplies the sequence values by an incorrect factor.
...
.. multichoice::
    ...
    [ ] The range function boundaries grow larger automatically on every iteration. | Incorrect. The stop parameters inside range() stay fixed unless updated via code logic.
