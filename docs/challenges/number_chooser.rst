...
| A number chooser can be used for a variety, including, sending via radio to other microbits.
...
| To make sure **num** doesn't just keep increasing without limit, if it is already 9 when the A button is pressed, it is reset to 0.
