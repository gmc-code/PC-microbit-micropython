...
| In the code below, the ``delay_time`` variable is increased in steps of 10 by the A the A buttonnd decreased in steps of 10 by the B button. Finally, text is scrolled with a delay of ``delay_time``.
