...
| e.g "a*c*e*"
| See the `Spacing characters under EXT: for-loops <https://pc-microbit-micropython.readthedocs.io/en/latest/lessons/For_loops_2.html>`_#spacing-characters>`__ for ideas to get "a*c*e" instead of "a*c*e*".
...
| For examples of using nested for-loops specific to the microbit display see the `Setting Pixels page under Images <https://pc-microbit-micropython.readthedocs.io/en/latest/images/setting_pixels.html>`_#pixel-rows-and-columns-lists>`__.
