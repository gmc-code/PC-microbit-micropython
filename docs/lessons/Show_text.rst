...
.. py:function:: show(value)
    ...
    | Each letter, digit or image is shown with 400 milliseconds between them.
...
To show the string, "Hi", with a short delay of about 200:
...
.. admonition:: Tasks
    ...
    #. Write code to show info about the number of children in your family.    
    #. Write code to show a countdown from 5 to 0.
